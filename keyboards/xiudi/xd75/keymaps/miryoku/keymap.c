...
enum layer_names {
	_BAS, // base layer, colemak mod-dh
	_WKM, // dvorak
	_DVK, // qwerty
	_QWT, // workman
	_GME, // gaming, left split only
	_NAV, // navigation, media
	_NUM, // numbers
	_SYM, // symbols
	_FUN, // F1-F15, micros, keyboard
};
/*
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BAS] = LAYOUT_ortho_5x15( /* QWERTY */
      ...
      _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    GUI_T(KC_SPC),    _______, CTL_T(KC_ENT), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______,
      _______, _______, _______, _______, LT(L_NAV,KC_ESC), LT(L_NUM,KC_TAB), _______, _______, _______, LT(L_SYM,KC_BSPC), LT(L_FUN,KC_DEL),  _______,_______, _______, _______
    ),
